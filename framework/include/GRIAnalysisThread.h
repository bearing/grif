...
#ifndef GRIF_FRAMEWORK_INCLUDE_GRI_ANALYSIS_THREAD_H_
#define GRIF_FRAMEWORK_INCLUDE_GRI_ANALYSIS_THREAD_H_
...
#endif  // GRIF_FRAMEWORK_INCLUDE_GRI_ANALYSIS_THREAD_H_
