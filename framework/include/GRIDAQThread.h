...
class GRIDAQThread : public GRIProcessThread {
 ...
 protected:
  ...
  //
  // numel is the number of data elements
  // buffer_name is the name of the buffer where the data will be stored
  // data is the array of data elements.  This array should contain numel
  //      data elements of the templated type
  // timestamps is an array of timestamps corresponding to data.  This array
