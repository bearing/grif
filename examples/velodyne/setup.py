...
os.system("python2 {0} {1} {2}".format(loader, loader_xml, loader_aux))
print "Running code generation for user loader..."
os.system("python2 {0} {1} {2}".format(user_loader, classes_xml, user_loader_aux))
print "Running code generation for user processes..."
os.system("python2 {0} {1} {2}".format(user_procs, classes_xml, procs_aux))
