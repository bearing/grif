...
// TODO(arbenson): Hook for later integration...
// int GRIAnalysisThread::CreateNewHistogram(QString HistName, int nx,
//                                           double xBins[], int ny,
//                                           double yBins[],int nz,
//                                           double zBins[]) {
...
//    if(this->GetHistogram(HistName) == 0){
//        GRIHistogrammer* p = new GRIHist2D(this->get_name(),hist_array_.size(),HistName);
//        p->SetBins(nx,xBins,ny,yBins);
//        hist_array_.push_back(p);
//        return 0;
//    }else{
...
int GRIAnalysisThread::CreateNewHistogram(QString HistName, int nx,
                                          double xmin, double xmax, int ny,
                                          double ymin, double ymax, int nz,
                                          double zmin, double zmax) {
    // This is 3 dimensional
    if (this->GetHistogram(HistName) == 0) {
        GRIHist3D* p = new GRIHist3D(this->get_name(),hist_array_.size(),HistName);
